...
class Population:
    ...
    def __init__(
        self, n_pop, x_bound, y_bound, N, elitism_num, crossover_frac, mutation_frac, grid_size
    ):
        self.n_pop = n_pop
    ...
    def crossover_greedy(self, pop_matrix):
        ...
        beta = np.random.random((int(self.n_pop-self.elitism_pop/2), 2 * self.N)) / 5
...
oldPop = Population(pop_size, x_bound, y_bound, n_turbines, elitism_num, crossover_rate, mutation_rate, grid_size)
...
for i in range(400):
    ...
    newPop = Population(pop_size, x_bound, y_bound, n_turbines, elitism_num, crossover_rate, mutation_rate, grid_size)
